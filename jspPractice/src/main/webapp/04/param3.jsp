...
<body>
	...
	1) 외부 파일 param3_data.jsp의 내용을 출력하도록 include 액션 태그의 page 속성을 작성
	2) 매개 변수 title과 값을 전송하기 위해 param 액션 태그를 작성
	한글이 깨지지 않도록 java.net.URLEncoder.encode() 메서드를 사용
	3) 매개 변수 date와 값을 전송하기 위해 param 액션 태그를 작성
	--%>
	<h2>param 액션 태그</h2>
	<jsp:include page="param3_data.jsp">
